...
Always add support for light/dark/system mode and render the system mode. This need not be an explicit toggle on the page, it should just respect the user's system preferences.
